    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 card-product">
            <div class="sub-card-product">
                <h6 class="m-0 font-weight-bold text-primary">Tất Cả User</h6>
                ...
                echo "<tbody>";
                    ...
                    <tr>
                        ...
                        <td class='card-table-item'>
                            ...
                            <form action='index.php?controller=user&action=edit&id=<?php echo $row['id']; ?>'
                                ...
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        ...
                                        <div class='card-body_item '>
                                            ...
                                            <div class='card-body_item '>
                                                <label for=''>Tên user<sup>*</sup></label>
                                            ...
                                            <div class='card-body_item '>
                                                ...
                                                <input class='card-body_input' type='pass' name='pass'
                                            ...
                                            <div class='card-body_item '>
                                                <label for=''>Avatar<sup>*</sup></label>
                                                <input class='card-body_input' type='file' name='ava'
                                                    value='<?php echo $row ['ava']; ?>' required>
                            ...
                            <a class='card-table-link'
                                href='index.php?controller=user&action=delete&id=<?php echo $row['id']; ?>'
